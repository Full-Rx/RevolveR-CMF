...
<footer class="revolver__footer <?php print $auth_class; ?>">
	...
	<p><a href="https://revolvercmf.ru" title="RevolveR CMF by RevolveR Labs powered" target="_blank">RevolveR CMF</a> | <?php print $title; ?> | <span><?php print date('Y'); ?></span> <span id="jump">&#8679;</span></p>
