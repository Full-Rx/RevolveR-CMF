...
$form_parameters = [
	...
	// Main parameters
	'id' 	  => 'comment-store-add-form',
	'class'	  => 'revolver__comment-store-add-form revolver__new-fetch',
...
if( FORM_ACCESS !== 'none' ) {
	...
	$form_parameters['fieldsets']['fieldset_1']['title:html'] = $RKV->lang['Add a comment as'] .' '. USER['name'];
